...
import com.rondaulagupu.ronx.movieshub.adapter.MovieCastAdapter;
import com.rondaulagupu.ronx.movieshub.adapter.MovieReviewsAdapter;
import com.rondaulagupu.ronx.movieshub.adapter.MovieTrailerAdapter;
...
import com.rondaulagupu.ronx.movieshub.model.Cast;
import com.rondaulagupu.ronx.movieshub.model.CastResponse;
import com.rondaulagupu.ronx.movieshub.model.Movie;
import com.rondaulagupu.ronx.movieshub.model.Review;
import com.rondaulagupu.ronx.movieshub.model.ReviewsResponse;
import com.rondaulagupu.ronx.movieshub.model.Trailer;
import com.rondaulagupu.ronx.movieshub.model.TrailersResponse;
...
public class DetailActivity extends AppCompatActivity {
    ...
    @BindView(R.id.cast_top_border)
    ImageView castTopBorderImageView;
    @BindView(R.id.trailers_top_border)
    ImageView trailersTopBorderImageView;
    @BindView(R.id.reviews_top_border)
    ImageView reviewsTopBorderImageView;
    @BindView(R.id.tv_movie_cast_title)
    TextView mMovieCastTitleTextView;
    @BindView(R.id.tv_movie_trailers)
    TextView mMovieTrailersTitleTextView;
    @BindView(R.id.tv_movie_reviews)
    TextView mMovieReviewsTitleTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<CastResponse>() {
            ...
            public void onResponse(Call<CastResponse> call, Response<CastResponse> response) {
                ...
                if(casts.size() == 0) {
                    mMovieCastRecyclerView.setVisibility(View.GONE);
                    castTopBorderImageView.setVisibility(View.GONE);
                    mMovieCastTitleTextView.setVisibility(View.GONE);
                } else {
                    mMovieCastRecyclerView.setVisibility(View.VISIBLE);
                    castTopBorderImageView.setVisibility(View.VISIBLE);
        ...
        trailersResponseCall.enqueue(new Callback<TrailersResponse>() {
            ...
            public void onResponse(Call<TrailersResponse> call, Response<TrailersResponse> response) {
                ...
                if(trailers.size() == 0) {
                    mMovieTrailersRecyclerView.setVisibility(View.GONE);
                    mMovieTrailersTitleTextView.setVisibility(View.GONE);
                    trailersTopBorderImageView.setVisibility(View.GONE);
                } else {
                    mMovieTrailersRecyclerView.setVisibility(View.VISIBLE);
                    mMovieTrailersTitleTextView.setVisibility(View.VISIBLE);
                    trailersTopBorderImageView.setVisibility(View.VISIBLE);
        ...
        reviewsResponseCall.enqueue(new Callback<ReviewsResponse>() {
            ...
            public void onResponse(Call<ReviewsResponse> call, Response<ReviewsResponse> response) {
                ...
                if(reviews.size() == 0) {
                    ...
                    mMovieReviewsTitleTextView.setVisibility(View.GONE);
                    reviewsTopBorderImageView.setVisibility(View.GONE);
                } else {
                    mMovieReviewsTitleTextView.setVisibility(View.VISIBLE);
                    mMovieReviewsRecyclerView.setVisibility(View.VISIBLE);
                    reviewsTopBorderImageView.setVisibility(View.VISIBLE);
    ...
    protected void onDestroy() {
        ...
        editor.putInt(MoviesAdapter.CURRENT_POSITION, 0)
                .apply();
    }
}
